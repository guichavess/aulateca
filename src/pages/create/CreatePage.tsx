...
import type { AgeRange, CategoryId } from '@/lib/types';
...
const CreatePage: React.FC = () => {
  ...
  const canSubmit =
    !!title.trim() && !!description.trim() && !!category && !!ageRange && !!duration && !submitting;
  ...
  return (
    <div className="px-4 py-6 max-w-lg mx-auto space-y-6 animate-slide-up">
      <div>
        <h1 className="font-fredoka text-h1 font-bold text-ink mb-1">Criar Novo Recurso ✨</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {/* Submit */}
        {/* Era um gradiente roxo com glow difuso, montado em `style` inline —
            e o roxo nem era o da marca. Agora é o botão do design system, que
            já sabe afundar ao ser pressionado e apagar o relevo quando
            desabilitado. */}
